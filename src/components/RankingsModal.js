// src/components/RankingsModal.js
import React from 'react';
import { BookOpen } from 'lucide-react'; // Import icon here
import { levelUpThresholds } from '../data/gameData'; // For XP calculation display

const RankingsModal = ({ allRankings, onClose }) => {
  return (
